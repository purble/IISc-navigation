...
class iisc_rf_net(object):
    ...
    def init_params(self):
        self.weights = {
            ...
            'wc2': self.weight_scale*tf.Variable(tf.random_normal([3,3,self.num_filters[1],self.num_filters[2]]), name='wc2'),
            'wd1': self.weight_scale*tf.Variable(tf.random_normal([self.num_filters[2]*4*4,self.hidden_dims[0]]), name='wd1'),
